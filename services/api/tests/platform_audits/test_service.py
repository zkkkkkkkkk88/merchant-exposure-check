...
from app.platform_audits.service import PlatformAuditService, classify_platform
...
def test_platform_audit_run_is_isolated_and_aggregates_results(db_session: Session) -> None:
    ...
    service.record_platform(run.id, "amap", "高德地图", found=True, fields={"name": merchant.name, "address": merchant.address, "products": []}, evidence=[{"url": "https://example.com/amap", "title": "高德商户页"}])
